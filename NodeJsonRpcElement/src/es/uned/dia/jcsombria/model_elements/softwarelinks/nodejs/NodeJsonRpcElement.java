...
public class NodeJsonRpcElement extends AbstractModelElement { 
	...
	static ImageIcon ELEMENT_ICON = ResourceLoader.getIcon("es/uned/dia/jcsombria/model_elements/softwarelinks/nodejs/json.gif"); // This icon is included in this jar
	// Status messages
	...
	public String getConstructorName() {
		return "es.uned.dia.jcsombria.model_elements.softwarelinks.nodejs.Session";
	}
